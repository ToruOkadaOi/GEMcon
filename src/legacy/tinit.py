...
nomenclature = tinit_cfg.get(
    "nomenclature", "ensembl_gene_id"
)  # default to ensembl here
...
if not essential_rxn_ids:
    user_input = input(
        "\nEnter essential reaction ids (eg,MAR13082 in Human-GEM): "
    ).strip()
...
ctx_model.remove_reactions(
    to_remove, remove_orphans=True
)  # TODO: altenative to removing?
...
cobra.io.write_sbml_model(
    ctx_model, f"{mod_dir}/tinit_context_specific_model_{base}.xml"
)
