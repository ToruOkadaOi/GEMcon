...
expression_data = pd.read_csv(
    "/home/biodata/aman/data/data_processed/expression_data_hippocampus-development-human-brain-10XV2_annotated_normalized_annotated_gencode.csv",
    index_col=0,
)
...
omics_container = TabularReader(
    path_or_df=expression_data_T, nomenclature="gene", omics_type="transcriptomics"
).to_containers()
